# backend/smartinventory/settings.py
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # Localhosts allowed for dev
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Add your templates folder if any
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database (example with SQLite for quick setup)
DATABASES = {
    'default': {
